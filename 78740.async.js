"use strict";(self.webpackChunkscene_pro=self.webpackChunkscene_pro||[]).push([[78740],{79817:function(e,t,r){r.d(t,{L:function(){return I},b:function(){return A}});var i=r(35567),a=r(27349),n=r(11005),s=r(40122),o=r(87263),c=r(7086),l=r(13743),p=r(45701),d=r(96541),h=r(37124),v=r(23027),u=r(2013),f=r(13663),T=r(48857),m=r(18489),S=r(34709),P=r(52061),g=r(26723),O=r(75047),_=r(15150);function A(e){const t=new _.kG,{space:r,anchor:A,hasTip:I}=e,E=r===g.I9.World;t.include(n.U,e),t.include(o.Q,e),t.include(c.H,e);const{vertex:R,fragment:w,varyings:y}=t;w.include(p.n),(0,d.Sv)(R,e),t.attributes.add(P.T.POSITION,"vec3"),t.attributes.add(P.T.PREVIOUSDELTA,"vec4"),t.attributes.add(P.T.UV0,"vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),I&&y.add("vLineWidth","float"),R.uniforms.add(new h.$("nearFar",(({camera:e})=>e.nearFar)),new v.$("viewport",(({camera:e})=>e.fullViewport))).code.add(T.H`vec4 projectAndScale(vec4 pos) {
...
return vec2(v.y, -v.x);
      ...
      ${D} displace(${D} pos, ${D} prev, float displacementLen) {
        ...
        ${A===g.i5.Tip?"pos -= 0.5 * displacementLen * displacementDirV;":""}
